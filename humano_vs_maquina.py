...
def adivinar_numero_humano():
    print(""" Ahora será tu turno!!!.""")
    numero = random.randint(1,100)
    numero_adivinado = int(input(""" Adivina el número que he pensado: """))
    intentos = 1
    ...
    print(""" Has adivinado mi número en un total de """ + str(intentos) + " intentos.")
    return intentos


def adivinar_numero_maquina():
    inicio=''
    print("""Adivinaré el número que estás pensando. """)
    while inicio != 'ok':
